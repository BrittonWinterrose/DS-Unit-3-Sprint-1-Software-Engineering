...
object-oriented programming, code sqtyle/reviews, containers, and testing. Your
...
#### Answer 1: Readibility is what I would consider to be the most important part of code reviews because if I am unable to make sense of the code while reviewing the code with the programmer who made it then how is someone who comes across it in the future supposed to do any better? The goal is to create an artifact of code that can be used, reused and improved. 

#### Answer 2: Containers would allow you to create consistent development, operations, and hosting environments by allowing packages and programs to be consistent across all computers. A container once configured contains all the needed packages, software, dependencies... even an OS, and as such can deliver exact consistency of experience (outside of hardware constraints) for all users who deploy it. It can also be centrally managed and hosted on a repository for convenient scalable deployment.
